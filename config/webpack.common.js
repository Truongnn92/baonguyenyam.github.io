...
const METADATA = yaml.load(fs.readFileSync("./_config.yml"));
...
module.exports = {
   ...
   */
  entry: {
    'core': './src/polyfills.ts',
    'plugins': './src/vendor.ts',
    'biz4xapp': './src/bootstrap.ts'
  },
  ...
  resolve: {
     ...
     */
    extensions: ['', '.ts', '.js', '.json', '.css', '.sass', '.scss', '.html', '.jade', '.pug'],
  ...
  module: {
    ...
    loaders: [
...

      {
        ...
        loader: "file-loader?name=/images/biz4x-[sha512:hash:base64:8]-[name].[ext]?[hash]"
      }, {
        test: /\.(woff|woff2|ttf|eot)$/,
        loader: 'file-loader?name=/fonts/biz4x-[hash:6]-[name].[ext]?[hash]'
      }, {
        test: /\.json$/,
        loader: 'json-loader'
      }, {
  ...
  plugins: [
    ...
    new webpack.optimize.CommonsChunkPlugin({
      name: helpers.reverse(['core', 'plugins', 'biz4xapp'])
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      inject: 'body',
      chunksSortMode: helpers.packageSort(['core', 'plugins', 'biz4xapp'])
    }),
